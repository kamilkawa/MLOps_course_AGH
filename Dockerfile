...
#Colima without BuildKit, so i'll remove caching. Let's say I am okey with more time required to
#create a build for this lab
...
#Run the application with uvicorn, binding to all interfaces on port 8000, customize for my repo structure
